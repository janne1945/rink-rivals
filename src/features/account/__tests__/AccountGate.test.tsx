...
function createRepository(profile: AccountProfile = readyProfile): AccountRepository {
  return {
    ...
    abandonOpenMatch: vi.fn().mockResolvedValue({ status: "none", clientMatchId: null }),
    ...
    abandonOpenArenaMatch: vi.fn().mockResolvedValue({ status: "none", clientMatchId: null }),
    ...
    abandonOpenRivalryChallenge: vi.fn().mockResolvedValue({ status: "none", clientMatchId: null }),
